...
stdio, calls the `get_component` tool with refdes "U1", and dumps the result
to stdout.
...
def main():
    ...
    parser.add_argument(
        "-r", "--refdes", default="U1",
        help="component reference designator to look up (default: U1)",
    )
    ...
    try:
        ...
        init = server.request("initialize", {
            ...
            "capabilities": {},
            "clientInfo": {"name": "test-get-component", "version": "0.1.0"},
        })
        ...
        print(f"=== get_component(refdes={args.refdes}) ===")
