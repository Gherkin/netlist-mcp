...
stdio, calls the `get_pin` tool with a given pin ("REFDES:PIN"), and dumps
...
def main():
    ...
    parser.add_argument(
        "-p", "--pin", default="U8:5",
        help="pin to look up, REFDES:PIN (default: U8:5)",
    )
    ...
    try:
        ...
        init = server.request("initialize", {
            ...
            "capabilities": {},
            "clientInfo": {"name": "test-get-pin", "version": "0.1.0"},
        })
