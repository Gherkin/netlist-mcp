...
stdio, calls the `get_net` tool with a given net name/code, and dumps the
result to stdout.
...
def main():
    ...
    parser.add_argument(
        "-n", "--net", default="GND",
        help="net name or code to look up (default: GND)",
    )
    ...
    try:
        ...
        init = server.request("initialize", {
            ...
            "capabilities": {},
            "clientInfo": {"name": "test-get-net", "version": "0.1.0"},
        })
